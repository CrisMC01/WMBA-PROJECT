            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                try
                {
                    ...
                    if (currentSeason != null)
                    {
                        ...
                        // Actualizar las propiedades del objeto currentSeason
                        currentSeason.SeasonCode = nextYear.ToString();
                        currentSeason.SeasonName = "Season " + nextYear.ToString();

                        // Marcar el objeto currentSeason como modificado
                        _context.Entry(currentSeason).State = EntityState.Modified;
